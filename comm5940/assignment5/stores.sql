...
CREATE TABLE `southwind`.`stores`(
  `storeID` int(4) primary key not null auto_increment,
...
INSERT INTO `southwind`.`stores`(`name`, `place`, `tel`, `cheapness`, `richness`, `review`, `url`) VALUES
